...
(function () {
  ...
  var mobileVideoUrl  = "assets/chalet-hero-mobil.mp4";   /* üresen hagyva a desktop tölt be */
  ...
  video.src = (isMobile && mobileVideoUrl) ? mobileVideoUrl : desktopVideoUrl;
  ...
  function onResize() {
    ...
    rt = window.setTimeout(function () { measure(); kick(); }, 150);
  }
  window.addEventListener('resize', onResize, { passive: true });
  window.addEventListener('orientationchange', function () {
    window.setTimeout(function () { measure(); cur = tgt = progress(); applyAll(cur); kick(); }, 320);
  });
